# Generated by Powerlevel10k configuration wizard on 2021-05-12 at 22:30 CEST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%95F'   # green foreground
      local   modified='%95F'  # yellow foreground
      local  untracked='%95F'   # blue foreground
      local conflicted='%95F'  # red foreground
    else
