...
augroup omnisharp_commands
    ...
    autocmd FileType cs inoremap <buffer> <C-x><C-s> :OmniSharpSignatureHelp<CR>

    " Navigate up and down by method/property/field
    autocmd FileType cs nnoremap <buffer> gk :OmniSharpNavigateUp<CR>
    autocmd FileType cs nnoremap <buffer> gj :OmniSharpNavigateDown<CR>
